...
function SensitivityWorkspace(props: {
  busy: boolean;
  scenario: string;
  scenarios: Scenario[];
  selectedScenario?: Scenario;
...
function SensitivityTable({ result }: { result?: SensitivityResult }) {
...
function SensitivityBarChart({ result }: { result?: SensitivityResult }) {
